<?php
	...
	class ShortcodeFacade
	{
		...
		public function serializeToText(ShortcodeInterface $s) {
			return $this->serialize($s, 'text');
		}
		...
		/** @deprecated use serialize($shortcode, $format) */
		public function serializeToJson(ShortcodeInterface $s) {
			return $this->serialize($s, 'json');
		}

		/** @deprecated use unserialize($shortcode, $format) */
		public function unserializeFromText($text) {
			return $this->unserialize($text, 'text');
		}
		...
		/** @deprecated use unserialize($shortcode, $format) */
		public function unserializeFromJson($text) {
			return $this->unserialize($text, 'json');
		}
	}
